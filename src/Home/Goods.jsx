  ...
  return (
    <div className='mt-[12rem]'>
      <div className='flex w-[100vw] items-center flex-col'>
        <p className='section-heading-accent uppercase text-[2rem] mobile:text-[1.6rem] transition-colors duration-400' style={{ color: 'var(--text-secondary)' }}>What we deal with !</p>
